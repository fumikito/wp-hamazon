      ...
      <div className="hamazon-modal-form-wrapper">
        <div className="hamazon-modal-form">
          <div className="hamazon-modal-form-item">
            ...
            <select id="hamazon-input-amazon-category" value={this.state.selectedMedia} onChange={(e) => {
          ...
          <div className="hamazon-modal-form-item">
            <label htmlFor="hamazon-input-phg-country" className="hamazon-modal-form-label">{HamazonEditor.countries}</label>
            <select id="hamazon-input-phg-country" value={this.state.selectedCountry} onChange={(e) => {
